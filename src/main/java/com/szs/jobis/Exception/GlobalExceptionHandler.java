...
public class GlobalExceptionHandler {
    ...
    protected ResponseEntity<CommonResponse> handleDuplicateMemberException(DuplicateUserException ex) {
        com.example.security.jwt.exception.ErrorCode errorCode = com.example.security.jwt.exception.ErrorCode.DUPLICATE_MEMBER_EXCEPTION;
    ...
    protected ResponseEntity<CommonResponse> handleInvalidRefreshTokenException(InvalidRefreshTokenException ex) {
        com.example.security.jwt.exception.ErrorCode errorCode = com.example.security.jwt.exception.ErrorCode.INVALID_REFRESH_TOKEN;
